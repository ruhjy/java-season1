...
//		System.arraycopy(folderA, 0, folderC, 0, 2);
		String[] folderC = System.arraycopy(folderA, 0, folderC, 0, 2);
		folderC[0] = "newFolder";
		...
		String[] folderD = Arrays.copyOf(folderA, 1); // Arrays.copyOf(folderA, folderA.length);
		folderD[0] = "newFolder";
		...
		String[] folderE = Arrays.copyOfRange(folderA, 0, 1); // Arrays.copyOfRange(folderA, 0, folderA.length);
		folderE[0] = "newFolder";
